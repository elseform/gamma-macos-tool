...
run("testSetupRequestIncludesDXMTOption", config.testSetupRequestIncludesDXMTOption)
run("testSetupRequestIncludesXRayD3DMetalWinetricksProfile", config.testSetupRequestIncludesXRayD3DMetalWinetricksProfile)
...
run("testSetupRequestIncludesWineDisplayMode", config.testSetupRequestIncludesWineDisplayMode)
...
run("testXRayD3DMetalWinetricksProfileOmitsCoreFonts", engine.testXRayD3DMetalWinetricksProfileOmitsCoreFonts)
run("testXRayD3DMetalOverridesKeepBackendOwnedDllsUnforced", engine.testXRayD3DMetalOverridesKeepBackendOwnedDllsUnforced)
...
run("testWineDisplayDefaultWritesNothingAndRetinaOffWritesOnlyRequiredValues", engine.testWineDisplayDefaultWritesNothingAndRetinaOffWritesOnlyRequiredValues)
...
run("testXRayD3DMetalProfileWritesLauncherWineOptions", engine.testXRayD3DMetalProfileWritesLauncherWineOptions)
...
run("testDXMTPayloadInstallationAndReplacement", engine.testDXMTPayloadInstallationAndReplacement)
...
run("testRecommendedSettingsDefaults", appSettings.testRecommendedSettingsDefaults)
run("testSaveAndLoadCustomRecommendedSettings", appSettings.testSaveAndLoadCustomRecommendedSettings)
run("testPartialRecommendedSettingsFallBackToDefaults", appSettings.testPartialRecommendedSettingsFallBackToDefaults)
run("testSaveGammaPathPreservesExistingRecommendedSettings", appSettings.testSaveGammaPathPreservesExistingRecommendedSettings)
run("testEnsureSettingsFileExistsCreatesDefaultJson", appSettings.testEnsureSettingsFileExistsCreatesDefaultJson)
run("testBundledRecommendedSettingsLoadedFromResourceFile", appSettings.testBundledRecommendedSettingsLoadedFromResourceFile)
