...
run("testCreateFlowEnvironmentRequiresSelectedModOrganizerButNotAutomaticGammaDiscovery", config.testCreateFlowEnvironmentRequiresSelectedModOrganizerButNotAutomaticGammaDiscovery)
